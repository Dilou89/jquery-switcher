...
function main(){
    ...
    */
    ...
    $('button').click(function(){
           ...
           // Récupérer le nom de l'image dans l'objet species                                                                                                                      
           var image = species[nomAnimal];
           //console.log('lien vers image : ' + image);
           // récupérer la cible dans laquelle placer l'image dans un objet jquery                                                                                                  
           var $cible = $('#holder');
           //console.log("cible de l'image" + $cible);
           // injecter l'image dand le div prevu a cet effet                                                                                                                        
           $cible.html('<img src="img/' + image + '">');
       });